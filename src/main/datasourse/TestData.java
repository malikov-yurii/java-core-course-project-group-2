...
public class TestData {
    ...
    public static void initializeDAOWithTestData(){
        ...
        RoomDAOImpl.initialize(new HashSet<>(Arrays.asList(
                ...
                ROOM0_DRUGHBA, ROOM1_DRUGHBA, ROOM2_DRUGHBA, ROOM3_DRUGHBA, ROOM4_DRUGHBA, ROOM5_DRUGHBA,  ROOM5_UKRAINA, ROOM6_DRUGHBA, ROOM7_DRUGHBA, ROOM8_DRUGHBA, ROOM9_DRUGHBA,
